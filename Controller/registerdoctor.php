...
$resultprovider=mysqli_query($conn,$sqlprovider);
$resultdegree=mysqli_query($connn,$sqldegree);
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Model/css/login_page.css">
	 <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
	<script type="text/javascript" src="js/jquery-3.2.1.min.js"></script>
	<script type="text/javascript" src="js/validatedoctor.js"></script> 
	 <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	 <script src="js/jquery.sumoselect.min.js"></script>
<link href="Model/css/sumoselect.css" rel="stylesheet" />

</head>

<body>

<div class="front-cadastrar" >
...
<input type="submit" id="submitbtn" value="register"  class="btn cadastrar-btn">
				...
				else
				{
					...
					$.ajax({
						...
						if (data.responseText && (json = $.parseJSON(data.responseText)))
						{
							...
							errorDiv.text('Solicitar failed.');
					});
				}
			}
		}).trigger("change");
