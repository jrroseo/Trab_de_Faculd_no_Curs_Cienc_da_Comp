...
<!--	<input type="radio" selected="" id="day" name="day" >  -->
	<a href="solicitar_horario.php?app_date='.$year.'-'.$month.'-'.$list_day.'&&doctor_user='.$_SESSION['docuser'].'" style="color:green; font-weight:bold; text-align:center; text-decoration:none; font-size:20px;"><ul>'.$list_day.'</ul></a>
	';
