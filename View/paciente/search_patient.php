	...
	<head>
		...
		<script language = "javascript">
			...
			function clicked(){
				...
				if(!search.value){
					alert('Você não digitou nenhum texto na caixa de pesquisa, digite novamente');
	...
	<div id = "menu_container">
		<div id="menu_wrapper">
			<ul class = "main_menu_left">
					...
					<li><a class="top_menu" href = "agendamentos_patient.php">Appointment</a></li>
		...
		<?php
			...
			if($rows==0){
				...
				for($j=0; $j<$rows; $j++){
					...
					echo '<tr><td>', $tuple['doctor_lname'],' ', $tuple['doctor_fname'] ,' ', $tuple['doctor_mname'], '</td>';
					echo '<td>', $tuple['sname'], '</td>';
					echo '<td>', $tuple['hname'], '</td>';
					echo '<td><input type="submit" value="Solicitar Appointment"></td>';
					echo '</tr>';
